...
export default function IntroText() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-3xl mx-auto my-16 p-8 bg-[url('../images/menu.jpg')] bg-cover bg-no-repeat bg-center rounded-xl shadow-2xl border border-pink-200 backdrop-blur-sm" data-aos="fade-up" data-aos-duration="1000">
