    ...
    >
      ...
      <div className="max-w-5xl mx-auto mt-12">
        <div className="flex justify-end items-end flex-col text-right">
          ...
          <div className="relative pl-4 py-2 px-14 font-serif text-2xl border-l-4 border-gray-800">
            <Link
              to="/menu"
              className="text-gray-800 hover:text-pink-500 font-semibold tracking-wide transition"
            >
              Menu More...
            </Link>

            {/* 下線用 */}
            <div className="absolute bottom-0 left-0 h-[1px] w-60 bg-gray-800"></div>
          </div>
        </div>
      </div>
