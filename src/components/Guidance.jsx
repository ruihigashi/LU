...
export default function Footer() {
    return (
        <section
            className="bg-[url('../assets/Images/p0520_l.jpg')] bg-cover bg-center text-white text-sm py-16 px-4"
            id="guidance"
        >
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mx-auto w-fit grid gap-y-6 gap-x-4 text-left" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-out-cubic" style={{ display: 'grid', gridTemplateColumns: '100px auto' }}>
                    ...
                    <div className="max-w-md whitespace-pre-wrap">
                        ■最寄りのバス停は【出口団地前】です。<br />
                        バスを降りたら右手の方向へ進んでください。<br />
                        しばらくまっすぐ歩くと、「旬彩馳走亭 満井」というお店の看板が目の前に見えてきます。<br />
                        その看板の少し手前を左に曲がり、そのまま直進すると、左手に「LUANA」の看板が見えてきます。<br />
                        看板のある建物が当店です。どうぞお気をつけてお越しください。<br />
                        <br />
