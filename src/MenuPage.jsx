...
export default function MenuSection() {
    ...
    const menuData = [
        ...
        },
        {
            ...
            items: [
                { name: "着付け（成人）", price: "¥8,800", desc: "一生に一度の晴れ舞台にふさわしい、丁寧で華やかな着付け。\n日本髪：+¥2,200\n※早朝料金（午前9時前からの方）: +¥2,200" },
                { name: "着付け（男性）", price: "¥5,500", desc: "夏祭りや花火大会にぴったりな、浴衣のシンプルで着崩れしにくい着付け。\n日本髪：+¥2,200\n※早朝料金（午前9時前からの方）: +¥2,200" },
                { name: "着付け（女性）", price: "¥6,600", desc: "帯結びまで美しく仕上げる、浴衣の華やかで涼しげな着付け。\n日本髪：+¥2,200\n※早朝料金（午前9時前からの方）: +¥2,200" },
                { name: "袴着付け", price: "¥5,500", desc: "式典にぴったりな、動きやすさと美しさを両立した袴の着付け。\n日本髪：+¥2,200\n※早朝料金（午前9時前からの方）: +¥2,200" },
